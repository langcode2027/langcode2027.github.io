...
- `index.html` — single-page site (At a glance, About, Why LangCode, Topics,
  Shared Tasks, Dates, Speakers, Organizers, Program Committee, Format, Contact)
...
- `js/main.js` — theme toggle, reading-progress bar, scroll reveals, stat
  count-ups, nav scrollspy, and the polyglot typewriter in the hero.
